		...
		<div class="page-in-container">
			...
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
							 Это самый лучший Дискриминант и не надо сомневатьс <a href="https://www.youtube.com/channel/UCNmYLoCFACetKMM67tnY5og">Клик хуик</a>
						</p>
					</div>
				</div>
			</div>
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					<div class='container-tx1-block darkmode-txt'>
						...
						<h2>Как можно зайти на этот Дискриминант?</h2>
					</div>
					<div class='container-tx2-block darkmode-txt'>
						<p>
							 еще раз повторяю для слепых <a href="https://www.youtube.com/channel/UCNmYLoCFACetKMM67tnY5og">Дискриминант</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
							 Дискриминант<a href="https://www.youtube.com/channel/UCNmYLoCFACetKMM67tnY5og">Дискриминант</a>.
						</p>
					</div>
				</div>
			</div>
